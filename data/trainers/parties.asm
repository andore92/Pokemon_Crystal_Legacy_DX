...
RedGroup:
	...
	db 77, CHARIZARD,  CHARCOAL,       FIRE_BLAST, WING_ATTACK, OUTRAGE, STEEL_WING ;replace fire blast with flare blitz eventually
	...
	db "RED@", TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
		...
		db 77, CHARIZARD
			...
			dw $01FE, $01FE, $01FE, $01FE, $01FE ; hp, atk, def, spd, spc
			db CHARCOAL
			db FIRE_BLAST, WING_ATTACK, OUTRAGE, STEEL_WING ;replace fire blast with flare blitz eventually
		db 77, VENUSAUR
			db $fd, $de
			dw $01FE, $01FE, $01FE, $01FE, $01FE ; hp, atk, def, spd, spc
			db MIRACLE_SEED

...
ErikaGroup:
	...
	db 62, VICTREEBEL, POISON_BARB,     SLUDGE_BOMB, GIGA_DRAIN, SWORDS_DANCE, SLEEP_POWDER ;replace sludge bomb with poison jab eventually
...
JanineGroup:
	...
	db 62, MUK,         NO_ITEM,        MINIMIZE, SLUDGE_BOMB, TOXIC, ACID_ARMOR ; replace sludge bomb with poison jab eventually
...
CooltrainerMGroup:
	...
	db 50, FLAREON,    SAND_ATTACK, QUICK_ATTACK, BITE, FLAMETHROWER ;Replace flame thrower with flare blitz eventually
	...
	db 55, FLAREON,    SAND_ATTACK, QUICK_ATTACK, BITE, FLAMETHROWER ;Replace flame thrower with flare blitz eventually
	...
	db 45, ARCANINE,  FLAMETHROWER, EXTREMESPEED, TAKE_DOWN, IRON_TAIL ;Replace flamethrower with flare blitz eventually
...
BlaineGroup:
	...
	db 66, RAPIDASH,   QUICK_CLAW,     HEADBUTT, SUNNY_DAY, FIRE_BLAST, SOLARBEAM ;replace fire blast with flare blitz eventually
	...
	db 67, ARCANINE,   CHARCOAL,       CRUNCH, DRAGONBREATH, FIRE_BLAST, EXTREMESPEED ;replace fire blast with flare blitz eventually
	db -1 ; end
...
BlueGroup:
	...
	db 69, ARCANINE,  PINK_BOW,      FLAMETHROWER, CURSE, CRUNCH, EXTREMESPEED ;replace flamethrower with flare blitz eventually
	db -1 ; end

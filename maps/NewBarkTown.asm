	...
	const NEWBARKTOWN_MOVE_RELEARNER
...
NewBarkTown_MapEvents:
	...
	object_event  7,  8, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, NewBarkTown_MoveRelearner, -1
